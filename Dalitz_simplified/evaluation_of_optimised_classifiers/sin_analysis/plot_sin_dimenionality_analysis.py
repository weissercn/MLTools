...
# Options for mode 'ensemble', 'ensemble_noCPV'
MODE= 'ensemble_noCPV'
...
if MODE == 'ensemble':
	...
	for dim in range(2,11):
		temp1,temp2,temp3 = np.loadtxt("../bdt_sin/"+str(dim)+'Dsin1diff_5_and_6_bdt_p_values_1_2_3_std_dev.txt')
	...
	p_3_svm = []
	for dim in range(2,11):
		temp1,temp2,temp3 = np.loadtxt("../svm_sin/"+str(dim)+'Dsin1diff_5_and_6_svm_p_values_1_2_3_std_dev.txt')
	...
	print("Miranda 5 bins: ", p_1_miranda_5bins,p_2_miranda_5bins,p_3_miranda_5bins)
        ...
        p_3_miranda_6bins = []
        for dim in range(2,11):
                temp1,temp2,temp3 = np.loadtxt("../miranda_sin/sin1diff_5_and_6_periods_p_value_distribution_miranda_"+str(dim)+'D_6_bins_p_values_1_2_3_std_dev.txt')
        ...
        p_3_miranda_7bins = []
        for dim in range(2,11):
                temp1,temp2,temp3 = np.loadtxt("../miranda_sin/sin1diff_5_and_6_periods_p_value_distribution_miranda_"+str(dim)+'D_7_bins_p_values_1_2_3_std_dev.txt')
	...
	ax.legend(loc='right')
	fig_name="sin1diff_5_and_6_periods_dimensionality_analysis"
	...
	print("Saved the figure as" , fig_name+".png")
        ...
        p_3_bdt = []
        for dim in range(2,11):
                temp1,temp2,temp3 = np.loadtxt("../bdt_sin/"+str(dim)+'Dsin1diff_5_and_5_noCPV_bdt_p_values_1_2_3_std_dev.txt')
                p_1_bdt.append(temp1), p_2_bdt.append(temp2), p_3_bdt.append(temp3)
        ...
        p_3_svm = []
        for dim in range(2,11):
                temp1,temp2,temp3 = np.loadtxt("../svm_sin/"+str(dim)+'Dsin1diff_5_and_5_noCPV_svm_p_values_1_2_3_std_dev.txt')
                p_1_svm.append(temp1), p_2_svm.append(temp2), p_3_svm.append(temp3)
	...
	p_1_miranda_6bins = []
        ...
        p_3_miranda_6bins = []
        for dim in range(2,11):
                temp1,temp2,temp3 = np.loadtxt("../miranda_sin/sin1diff_5_and_5_periods_noCPV_p_value_distribution_miranda_"+str(dim)+'D_6_bins_p_values_1_2_3_std_dev.txt')
                p_1_miranda_6bins.append(temp1), p_2_miranda_6bins.append(temp2), p_3_miranda_6bins.append(temp3)
        ...
        p_3_miranda_7bins = []
        for dim in range(2,11):
                temp1,temp2,temp3 = np.loadtxt("../miranda_sin/sin1diff_5_and_5_periods_noCPV_p_value_distribution_miranda_"+str(dim)+'D_7_bins_p_values_1_2_3_std_dev.txt')
                p_1_miranda_7bins.append(temp1), p_2_miranda_7bins.append(temp2), p_3_miranda_7bins.append(temp3)
        ...
        ax.legend(loc='right')
        fig_name="sin1diff_5_and_5_periods_noCPV_dimensionality_analysis"
        fig.savefig(fig_name)
        fig.savefig("../bdt_sin/"+fig_name)
        fig.savefig("../svm_sin/"+fig_name)
        fig.savefig("../miranda_sin/"+fig_name)
