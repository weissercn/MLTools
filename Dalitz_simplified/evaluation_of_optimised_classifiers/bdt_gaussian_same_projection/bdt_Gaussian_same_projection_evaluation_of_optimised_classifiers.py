...
for dim in range(7,11):
	...
	for i in range(100):
        ...
        args=[str(dim)+ "Dgaussian_same_projection_redefined__0_1__0_075_bdt","particle","antiparticle",100,comp_file_list,1,clf,np.logspace(-2, 10, 13),np.logspace(-9, 3, 13),0]
        #For nn:
