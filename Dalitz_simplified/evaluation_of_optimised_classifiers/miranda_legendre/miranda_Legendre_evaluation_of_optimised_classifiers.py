...
orig_name="legendre_p_value_distribution_10vs9_CPV_miranda"
sample1_name="particle"
sample2_name="antiparticle"

shuffling_seed = 100 

single_no_bins_list=[2,9,15,30,100]




##############################################################################
for dim_data in range(1,2):
	...
	for single_no_bins in single_no_bins_list:
		...
		for comp_file_0,comp_file_1 in comp_file_list:
			name = orig_name + "_" + str(single_no_bins)
