...
for comp_file_0,comp_file_1 in comp_file_list:
	...
	with open(os.path.expandvars("$MLToolsDir")+"/Dalitz/test_statistic_distributions/test_statistics_"+name+"_"+sample1_name+"_"+sample2_name+"_miranda_"+str(no_dim)+"_"+str(single_no_bins), "a") as test_statistics_file:
