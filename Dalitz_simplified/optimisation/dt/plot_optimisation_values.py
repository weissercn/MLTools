...
data=np.loadtxt("dt_optimisation_values.txt",dtype='d')
x=data[:50,0]
y=data[:50,1]
z=data[:50,2]
...
ax1.set_title('optimisation of hyperparameters for dt Dalitz')
fig.savefig("dt_optimisation_values_Dalitz.png")
