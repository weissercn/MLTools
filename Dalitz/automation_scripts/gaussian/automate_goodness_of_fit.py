...
for i in range(1,number_of_files+1):
	...
	os.system("python -O goodness_of_fit.py $MLToolsDir/Dalitz/gaussian_samples/gauss_data/data.2Dgauss_10000_0.5_0.1_0.5_0.1_{0}.0.txt $MLToolsDir/Dalitz/gaussian_samples/gauss_data/data.2Dgauss_10000_0.49_0.1_0.49_0.1_{0}.0.txt {1} {2} {3} {4}".format(i,name,sample1_name,sample2_name,shuffling_seed))
