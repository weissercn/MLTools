...
for i in range(35,number_of_files+1):
	...
	os.system("python  goodness_of_fit.py ../../dpmodel/data/data.{0}.0.txt ../../dpmodel/data/data.2{1}.1.txt {2} {3} {4} {5}".format(i-1,str(i-1).zfill(2),name,sample1_name,sample2_name,shuffling_seed))
