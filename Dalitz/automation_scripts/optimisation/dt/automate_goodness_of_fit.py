...
name           = "dalitz_max_features_optimisation"
...
classifier_name= "dectree"

#max_features_options=["auto","sqrt","log2",None]
#max_features_options=["best","random"]
max_features_options=range(2,100)
...
for i in range(1,number_of_files+1):
	...
	for max_features in max_features_options:
		for max_depth in range(26,27):
			os.system("python -O $MLToolsDir/Dalitz/goodness_of_fit.py $MLToolsDir/Dalitz/dpmodel/data/data.{0}.0.txt $MLToolsDir/Dalitz/dpmodel/data/data.2{1}.1.txt {2} {3} {4} {5} {6} {7} {8}".format(i-1,str(i-1).zfill(2),name,sample1_name,sample2_name,shuffling_seed,classifier_name,max_depth,max_features))
